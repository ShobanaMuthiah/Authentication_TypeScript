...
navigate('/' )
  ...
  return (
    ...
    <div className='basis-1/2'>
      ...
      <p className='py-3 px-3 text-center text-gray-600 border-1 border-gray-200 mx-2 cursor-pointer mt-2 rounded-md'>Create account with Google</p>
      <div>
...
<p>Already have an account? <a className='font-bold cursor-pointer' href='/signup'>Sign In</a></p>
  </form>
    </div>
